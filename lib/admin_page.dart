...
class _AdminPageState extends State<AdminPage>
  ...
  Future<void> _fetchUsers() async {
    ...
    try {
      final res = await http.get(
        Uri.parse(
            'http://myserver.lynzzofficial.com:2226/listUsers?key=$sessionKey'),
      );
  ...
  Future<void> _deleteUser() async {
    ...
    try {
      final res = await http.get(Uri.parse(
          'http://myserver.lynzzofficial.com:2226/deleteUser?key=$sessionKey&username=$username'));
      final data = jsonDecode(res.body);
  ...
  Future<void> _createAccount() async {
    ...
    try {
      final res = await http.get(Uri.parse(
          'http://myserver.lynzzofficial.com:2226/userAdd?key=$sessionKey&username=$username&password=$password&day=$day&role=$newUserRole'));
      final data = jsonDecode(res.body);
