  ...
  Future<void> _fetchSenders() async {
    ...
    try {
      final res = await http.get(
        Uri.parse("http://lightprivate.sistems.tech:2281/mySender?key=${widget.sessionKey}"),
  ...
  Future<void> _addSender(String number) async {
    ...
    try {
      final res = await http.get(Uri.parse(
          "http://lightprivate.sistems.tech:2281/getPairing?key=${widget.sessionKey}&number=$number"));
      if (res.statusCode == 200) {
        final data = jsonDecode(res.body);
        if (data["valid"] == true) {
  ...
  Future<void> _deleteSender(String senderId) async {
    ...
    try {
      final res = await http.delete(Uri.parse(
          "http://lightprivate.sistems.tech:2281/deleteSender?key=${widget.sessionKey}&id=$senderId"));
      if (res.statusCode == 200) {
        final data = jsonDecode(res.body);
        if (data["valid"] == true) {
